"""
Run YOLO-Seg inference on a video file.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights", required=True, help="Path to YOLO seg .pt file")
    parser.add_argument("--output", default="models/inference_output/yolo_seg_output.mp4")
