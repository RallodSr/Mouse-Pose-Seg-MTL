...
that joint training improves both tasks. To our knowledge, no prior
work applies MTL jointly for segmentation and pose estimation of
laboratory animals across diverse behavioral paradigms.
